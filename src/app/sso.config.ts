...
// &state=d1915eb682a3873af5b4459793360a670d676c3f',
  ...
  // redirectUri: 'https://my.local.host:4200/home',// 'https://my.local.host:4200/home' - window.location.origin + "/home"
  redirectUri: 'https://my.local.host:4200/home',

  // The SPA's id. The SPA is registerd with this id at the auth-server
  // clientId: '5iq89m609n0r209pbe71vht7qp', // foo
  clientId: 'Eh7NgldJ8kZxKrQNymdLarmRrGe6PQM0eGyuPAaA513B5mY', // foo
  // requireHttps: false,
